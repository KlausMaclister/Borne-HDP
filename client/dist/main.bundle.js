...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_data_bus_service__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_fetcher_service__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__inscription_inscription_component__ = __webpack_require__(82);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_fetcher_service__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_data_bus_service__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_startWith__ = __webpack_require__(172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_bus_service__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_catch__ = __webpack_require__(169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_data_bus_service__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(18);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return VisageComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VisageComponent = (function () {
    function VisageComponent(api, dataBus, router) {
        var _this = this;
        this.api = api;
        this.dataBus = dataBus;
        this.router = router;
        ...
        this.filterSoins = function (brand) {
            _this.allSoins = _this.bigArr.filter(function (parfum) {
                return parfum.brand === brand;
            });
        };
    }
    VisageComponent.prototype.ngOnInit = function () {
        this.fetchSoins();
    };
    VisageComponent.prototype.ngAfterViewChecked = function () {
        this.dataBus.setDataLoadingStatus(false);
    };
    VisageComponent.prototype.fetchSoins = function () {
        var _this = this;
        this.api.getSoins().subscribe(function (res) {
            _this.brands = Array.from(new Set(res.map(function (parfum) { return parfum.brand; }))).slice();
            _this.bigArr = res;
            var sub = res.slice(0, 200);
            _this.allSoins = sub;
...
var _a, _b, _c;
//# sourceMappingURL=visage.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__cart_cart_component__ = __webpack_require__(142);
...
var AppComponent = (function () {
    function AppComponent(dataBus, dialog, router) {
        ...
        this.isNotStoreView = function () {
            ...
            var bannedUrl = ['/language', '/presentation', '/tuktuk', '/itinerary'];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_http_service__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_payment_service__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__covalent_core__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_platform_browser_animations__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__routing__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__parfums_parfums_component__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__visage_visage_component__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__details_details_component__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_data_bus_service__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_fetcher_service__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__inscription_inscription_component__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__cart_cart_component__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__language_language_component__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__success_payment_success_payment_component__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__presentation_presentation_component__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__tuktuk_tuktuk_component__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__itinerary_itinerary_component__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__book_in_shop_book_in_shop_component__ = __webpack_require__(141);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__visage_visage_component__["a" /* VisageComponent */],
            __WEBPACK_IMPORTED_MODULE_13__details_details_component__["a" /* DetailsComponent */],
            __WEBPACK_IMPORTED_MODULE_16__inscription_inscription_component__["a" /* InscriptionComponent */],
            __WEBPACK_IMPORTED_MODULE_17__cart_cart_component__["a" /* CartComponent */],
            __WEBPACK_IMPORTED_MODULE_18__language_language_component__["a" /* LanguageComponent */],
            __WEBPACK_IMPORTED_MODULE_19__success_payment_success_payment_component__["a" /* SuccessPaymentComponent */],
            __WEBPACK_IMPORTED_MODULE_20__presentation_presentation_component__["a" /* PresentationComponent */],
            __WEBPACK_IMPORTED_MODULE_21__tuktuk_tuktuk_component__["a" /* TuktukComponent */],
            __WEBPACK_IMPORTED_MODULE_22__itinerary_itinerary_component__["a" /* ItineraryComponent */],
            __WEBPACK_IMPORTED_MODULE_23__book_in_shop_book_in_shop_component__["a" /* BookInShopComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_14__services_data_bus_service__["a" /* DataBusService */], __WEBPACK_IMPORTED_MODULE_15__services_fetcher_service__["a" /* FetcherService */], __WEBPACK_IMPORTED_MODULE_6__services_http_service__["a" /* CustomHttpService */], __WEBPACK_IMPORTED_MODULE_7__services_payment_service__["a" /* PaymentService */]],
        entryComponents: [__WEBPACK_IMPORTED_MODULE_17__cart_cart_component__["a" /* CartComponent */], __WEBPACK_IMPORTED_MODULE_16__inscription_inscription_component__["a" /* InscriptionComponent */]]
    })
], AppModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parfums_parfums_component__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__visage_visage_component__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__details_details_component__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__inscription_inscription_component__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__language_language_component__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__success_payment_success_payment_component__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__presentation_presentation_component__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tuktuk_tuktuk_component__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__itinerary_itinerary_component__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__book_in_shop_book_in_shop_component__ = __webpack_require__(141);
...
var appRoutes = [
    ...
    { path: 'presentation', component: __WEBPACK_IMPORTED_MODULE_8__presentation_presentation_component__["a" /* PresentationComponent */] },
    { path: 'tuktuk', component: __WEBPACK_IMPORTED_MODULE_9__tuktuk_tuktuk_component__["a" /* TuktukComponent */] },
    { path: 'visage', component: __WEBPACK_IMPORTED_MODULE_3__visage_visage_component__["a" /* VisageComponent */] },
    { path: 'details', component: __WEBPACK_IMPORTED_MODULE_4__details_details_component__["a" /* DetailsComponent */] },
    { path: 'inscription', component: __WEBPACK_IMPORTED_MODULE_5__inscription_inscription_component__["a" /* InscriptionComponent */] },
    { path: 'language', component: __WEBPACK_IMPORTED_MODULE_6__language_language_component__["a" /* LanguageComponent */] },
    { path: 'valid_payment', component: __WEBPACK_IMPORTED_MODULE_7__success_payment_success_payment_component__["a" /* SuccessPaymentComponent */] },
    { path: 'itinerary', component: __WEBPACK_IMPORTED_MODULE_10__itinerary_itinerary_component__["a" /* ItineraryComponent */] },
    { path: 'bookInShop', component: __WEBPACK_IMPORTED_MODULE_11__book_in_shop_book_in_shop_component__["a" /* BookInShopComponent */] }
];
...
module.exports = "\n<div layout=\"row\" layout-align=\"start\">\n  <ul id=\"parfumBrands\">\n    <li *ngFor=\"let brand of brands\" (click)=\"filterSoins(brand)\">{{brand}}</li>\n  </ul>\n  <div layout=\"row\" layout-wrap layout-align=\"start start\">\n    <div *ngFor=\"let soin of allSoins\">\n      <md-card class=\"product-card\" *ngIf=\"!hasNoUpdatedUrl(soin.image)\">\n        <md-card-header>\n          <md-card-title class=\"title\">{{soin.brand}}</md-card-title>\n          <md-card-subtitle class=\"desc\">{{soin.name}}</md-card-subtitle>\n        </md-card-header>\n        <div class=\"img-holder\">\n          <img md-card-image src=\"assets/{{soin.image}}\">\n        </div>\n        <md-card-content>\n          <p class=\"price\">\n            {{soin.price}}\n          </p>\n        </md-card-content>\n        <md-card-footer layout=\"row\" layout-align=\"center center\">\n          <button md-button class=\"cart-btn\" (click)=\"getDetails(soin)\">See More</button>\n        </md-card-footer>\n      </md-card>\n    </div>\n  </div>\n\n</div>\n\n\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Models_product__ = __webpack_require__(263);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__http_service__ = __webpack_require__(148);
...
var FetcherService = (function () {
    function FetcherService(http) {
        ...
        this.soins = 'assets/jsons/visage.json';
    ...
    FetcherService.prototype.getSoins = function () {
        return this.http.get(this.soins)
            .map(function (res) { return res.json(); })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Observable"].throw(error.json().error || 'Server error, could not fetch soins'); });
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__countries__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_payment_service__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__environments_environment__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_material__ = __webpack_require__(5);
